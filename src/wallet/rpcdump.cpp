...
"                                                              creation time of all keys being imported by the importmulti call will be scanned.",
                            ...
                            {"pubkeys", RPCArg::Type::ARR, RPCArg::DefaultHint{"empty array"}, "Array of strings giving pubkeys to import. They must occur in P2PKH scripts. They are not required when the private key is also provided (see the \"keys\" argument).",
                                {
                                    {"pubKey", RPCArg::Type::STR, RPCArg::Optional::OMITTED, ""},
                                }
                            },
                            {"keys", RPCArg::Type::ARR, RPCArg::DefaultHint{"empty array"}, "Array of strings giving private keys whose  corresponding public keys must occur in the output or redeemscript.",
                                {
